...
class Cart extends Component {
    ...
    handleClickCart = e =>  {
        console.log("id product masuk ke cart", this.props.location.pathname.slice(16))
        this.props.setIdProduct(this.props.location.pathname.slice(16))
        this.props.addToCart()
        this.props.history.push("/public/cartlist")
    }

    handleQtyChange = e => {
        console.log("id product masuk ke cart 17", this.props.location.pathname.slice(16))
        this.props.sendHargaProduct(this.props.productHarga)
        console.log("udah ke click nich")
                        ...
                        <tbody>
                            <tr>
                                <td style={{width:"170px", height:"auto"}}>
                                    <img src={this.props.productUrl} class="img-responsive" alt="" style={{width: "75%", height: "auto"}} />
                                </td>
                                <td>
                                ...
                                <td> @ Rp {this.props.productHarga}</td>
                                <td>@ Rp 15.000</td>
  ...
  export default connect(
    "is_login, productName, productHarga, productDetail, productUrl, ongkir, totalHarga, token,",
    actions
  )(withRouter(Cart));
