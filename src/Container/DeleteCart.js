...
class DeleteCart extends Component {
  ...
  handleClickDelete = e =>  {
    ...
    console.log("id yg mau di delete: ", this.props.location.pathname.slice(19))
    ...
    render() {
      ...
      return (
        ...
        <h2 style={{textAlign:"center", color:"#fe4c50"}}>Are You Sure you want to delete this cart?</h2>
        <div class="row">

            <div class="col-md-3 col-sm-3"></div>
            <div class="col-md-8 col-sm-8">
                <div class="check-out">
                    <h4>Click the button below to delete your cart.</h4>
                </div>
            </div>
