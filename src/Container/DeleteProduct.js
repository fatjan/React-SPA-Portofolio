...
class DeleteProduct extends Component {
  ...
  handleClickDelete = e =>  {
    this.props.setIdProduct(this.props.location.pathname.slice(22))
    console.log("id yg mau di delete: ", this.props.location.pathname.slice(22))
    this.props.deleteProduct()    
    this.props.history.push("/public/cartlist")
        };
      
    render() {
      console.log("ini location pathname baru", this.props.location.pathname.slice(22))
      return (
        ...
        <h2 style={{textAlign:"center", color:"#fe4c50"}}>Are You Sure you want to delete your product?</h2>
        <div class="row">

            <div class="col-md-3 col-sm-3"></div>
            <div class="col-md-8 col-sm-8">
                <div class="check-out">
                    <h4>Click the button below to delete your product.</h4>
                </div>
            </div>
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div className="row">
                        ...
                        <div class="col-md-6- col-sm-12 col-lg-6 text-center ">
                                ...
                                onClick={this.handleClickDelete} style={{backgroundColor:"#fe4c50", border:"0px"}}
