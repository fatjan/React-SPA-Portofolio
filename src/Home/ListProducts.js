...
class ListProducts extends Component {
    handleClickPilihProduct = e =>  {
        console.log("id product masuk ke cart", this.props.location.pathname.slice(12))
        this.props.setIdProduct(this.props.location.pathname.slice(12))
        this.props.sendProductDetailsToCart(this.props.img,this.props.name, this.props.harga)
    };
    ...
    return (
            ...
            <Col lg="3" md="4" sm="6" style={style} >
                ...
                <div class="flip-card-inner">
                    ...
                    {/* <h1>John Doe</h1>  */}
                    <div style={{color:"black", textAlign:"center"}}><strong><Link to={`/public/addcart/`+ this.props.id}  onClick={this.handleClickPilihProduct}>{this.props.name}</Link></strong></div> <br />
                   ...
                   <strong>Brand:</strong> {this.props.brand} <br/>
                     ...
                     <div style={{textAlign: "center"}} >
                                 ...
                                 <Link to={`/public/addcart/` + this.props.id} style={{color:"white"}}
                                     onClick={this.handleClickPilihProduct}
