...
class WomenContent extends Component {
	filter = () => {
		this.props.filterByPriceCatWomen()
	}
    render() {
      return (
				...
				<div class="col product_section clearfix">
					...
					<div class="breadcrumbs d-flex flex-row align-items-center">
						<ul>
							...
							<li class="active"><a href="index.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Women's</a></li>
						</ul>
					</div>
					...
					<div class="sidebar">
						<div class="sidebar_section">
							...
							<ul class="sidebar_categories">
								<li class="active"><Link to="/product/women"><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span>Women</Link></li>
